 ...
 * @author Luis Carlos
 */
public class FormaTablaEliminar extends javax.swing.JInternalFrame {

    public FormaTablaEliminar() {
        initComponents();
    ...
    public void crearColumnas(){
     ...
     public void crearColumnasMenos(){
    ...
    public void mostrarTabla()throws ClassNotFoundException{
        ...
        ImageIcon img = new ImageIcon("src/Imagenes/borrar.png"); 
    ...
    public void eliminarDatos(int numInterno){
